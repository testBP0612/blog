...
一般如果要將開發好的網站放上網路供人閱覽，一般會使用 Nginx 或 Apache 作為 web server。本文章將紀錄學習撰寫 `Dockerfile` 將本地 Next.js 應用程式 build 好的放入 Nginx 的過程。
...
![Untitled](Next%20js%20in%20Docker%20with%20Nginx%203d88df55b0164268b4eaabcb85ed2345/Untitled.png)
...
![SSR 運作原理 — 圖片來源  [Krusche Company](https://kruschecompany.com/ssr-or-csr-for-progressive-web-app/)](Next%20js%20in%20Docker%20with%20Nginx%203d88df55b0164268b4eaabcb85ed2345/Untitled%201.png)
